...
public class HmacAuthenticationFilter extends AuthenticatingFilter {
    ...
    protected long getClientTime(ServletRequest request) {
        ...
        //     }
        // }
        clientTime = Long.valueOf(dateHeader);
        return clientTime;
    }
    ...
    /**
     * 直接返回false，强制调用onAccessDenied进行header校验
     */
    @Override
    ...
    /**
     * 强制调用onAccessDenied进行header的Signature匹配校验，即强制调用HmacCredentialsMatcher.doCredentialsMatch
     */
    @Override
