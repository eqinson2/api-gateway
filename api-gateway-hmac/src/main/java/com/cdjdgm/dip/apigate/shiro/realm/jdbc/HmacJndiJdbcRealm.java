 ...
 * under the License.
 */
package com.cdjdgm.dip.apigate.shiro.realm.jdbc;
 ...
 */
public class HmacJndiJdbcRealm extends JndiJdbcRealm implements HmacRealm {

    protected static final String DEFAULT_SALTED_AUTHENTICATION_QUERY = "select 1, password_salt from users where username = ?";

    private static final Logger log = LoggerFactory.getLogger(HmacJndiJdbcRealm.class);

    protected String jndiDataSourceName;

    protected HmacBuilder hmacBuilder;

    public HmacJndiJdbcRealm() {
        super();
